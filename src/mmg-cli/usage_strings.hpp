...
namespace usage {
	...
	static const std::string repr_jobs =
		...
		//"    twocgr-(k=N|spacedseed=M)[-freq][-order={X[...],X[...]}]   (2-state CGR)\n"
		//"    twokrap-(k=N|spacedseed=M)[-order={X[...],X[...]}]         (2-state kRAP)\n"
		//"    twocv-(k=N|spacedseed=M)[-order={X[...],X[...]}]           (2-state CV)\n"
		"      Options:\n"
		"        k           Length of the substrings to count\n"
		//"        spacedseed  Specification of the spaced seed, as a position bitmask\n"
		"        freq        Use relative frequencies instead of occurrence counts\n"
		...
		//"    sparsetwocgr-(k=N|spacedseed=M)[-freq][-order={X[...],X[...]}][-freqcut=N]  (Sparse 2-state CGR)\n"
		//"    sparsetwokrap-(k=N|spacedseed=M)[-order={X[...],X[...]}][-freqcut=N]        (Sparse 2-state kRAP)\n"
		//"    sparsetwocv-(k=N|spacedseed=M)[-order={X[...],X[...]}][-freqcut=N]          (Sparse 2-state CV)\n"
		"      Options:\n"
		"        k           Length of the substrings to count\n"
		//"        spacedseed  Specification of the spaced seed, as a position bitmask\n"
		"        freq        Use relative frequencies instead of occurrence counts\n"
