...
#include <kameris-formats/cpp/common/binary_collection_io.hpp>
#include <kameris-formats/cpp/common/binary_io.hpp>
...
SCENARIO("kameris-formats binary IO", "[kameris-formats][common][binary]") {
	GIVEN("An integer") {
